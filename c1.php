...
<body>
	...
	<table style="width:100%">
		<tr style="outline: solid">
			...
			<td align="right"><br>
				<video height="315" controls><source src="files/firstprog_c.mp4"></video><br>
			</td>
		</tr>
	</table>
	<table style="width: 100%">
		<tr style="outline: solid">
			...
			<tr><td>Void datatypes</td><td>void</td></tr>
			</table>
			</p>
			</div></td>
			<td>
			<td align="right">
				<br><video height="315" controls><source src="files/dv.mp4"></video><br>
			</td>
		</tr>
	</table>
</body>
